...
public class MainActivity2 extends AppCompatActivity {
    ...
    //온도 꺼내오기 함수 ↓
            ...
            //시간 알고리즘 ↓
                if(Integer.parseInt(time.format(date))<300){
                    Log.i("timetest1","1");
                    cursor = sqlDB.rawQuery("Select * from village where fcstDate=baseDate+1 and fcstTime=0 and category='T3H';", null);
                    String fvale = "";
    ...
    public void weather() throws IOException {
        ...
        for(int i=1;i<25;i++) {
            ...
            //urlBuilder.append("&" + URLEncoder.encode("base_date", "UTF-8") + "=" + URLEncoder.encode("20210104", "UTF-8")); /*15년 12월 1일 발표*/
        ...
        cursor = sqlDB.rawQuery("Select * from village where category='T3H';", null);
            cursor.moveToNext();
                ...
                switch (Integer.parseInt(time.format(date))) {
                    ...
                    case 10:
                    case 11:
                        if (9 <= Integer.parseInt(time.format(date)) && Integer.parseInt(time.format(date)) < 11) {
                            onel2.setText("오늘");
                            onel++;
                        }
                        cursor.moveToNext();
                        ...
                        if (onel == 0 && Integer.parseInt(ftime) < 21) {
                            onel2.setText("오늘");
                            onel++;
                        } else if (ftime == "0") {
                            if (onel == 1) {
                    ...
                    case 16:
                    case 17:
                        if (15 <= Integer.parseInt(time.format(date)) && Integer.parseInt(time.format(date)) < 18) {
                            cursor.moveToNext();
                            cursor.moveToNext();
                        }
                        cursor.moveToNext();
                    ...
                    case 19:
                    case 20:
                        if (18 <= Integer.parseInt(time.format(date)) && Integer.parseInt(time.format(date)) < 21) {
                            cursor.moveToNext();
                            cursor.moveToNext();
                            cursor.moveToNext();
                        }
                        ...
                        /*여기서는 switch 밖으로 빼도 될듯↓*/
                    case 21:
                    case 22:
                    case 23:
                        if (21 <= Integer.parseInt(time.format(date)) && Integer.parseInt(time.format(date)) <= 23) {
                            cursor.moveToNext();
                            cursor.moveToNext();
                            cursor.moveToNext();
                        }
                ...
                if(Integer.parseInt(ftime)==21){
                    ...
                    switch (Integer.parseInt(time.format(date))) {
                        ...
                        case 1:
                        case 2:
                            if (0 <= Integer.parseInt(time.format(date)) && Integer.parseInt(time.format(date)) < 3) {
                                cursor.moveToNext();
                            }
                            cursor.moveToNext();
                            ftime = cursor.getString(4);
                        ...
                        case 4:
                        case 5:
                            if (3 <= Integer.parseInt(time.format(date)) && Integer.parseInt(time.format(date)) < 6) {
                                cursor.moveToNext();
                                cursor.moveToNext();
                            }
                            cursor.moveToNext();
                        ...
                        case 7:
                        case 8:
                            if (6 <= Integer.parseInt(time.format(date)) && Integer.parseInt(time.format(date)) < 9) {
                                cursor.moveToNext();
                                cursor.moveToNext();
                                cursor.moveToNext();
                            }
                        ...
                        case 10:
                        case 11:
                            if (9 <= Integer.parseInt(time.format(date)) && Integer.parseInt(time.format(date)) <= 12) {
                                cursor.moveToNext();
                                cursor.moveToNext();
                                cursor.moveToNext();
                            }
